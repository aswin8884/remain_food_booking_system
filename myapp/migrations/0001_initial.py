    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caters_license', models.FileField(null=True, upload_to='')),
                ('Id_proof', models.FileField(null=True, upload_to='')),
                ('cg_image', models.ImageField(null=True, upload_to='')),
                ('ck_image', models.ImageField(null=True, upload_to='')),
